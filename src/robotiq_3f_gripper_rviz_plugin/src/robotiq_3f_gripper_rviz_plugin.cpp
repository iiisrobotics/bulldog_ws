...
namespace robotiq_3f_gripper_rviz_plugin {
...
#include "robotiq_3f_gripper_rviz_plugin.moc"

#include <pluginlib/class_list_macros.h>
PLUGINLIB_EXPORT_CLASS(robotiq_3f_gripper_rviz_plugin::Robotiq3FingerPanel,rviz::Panel )
